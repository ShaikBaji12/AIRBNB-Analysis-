...
def datafr():
    df=pd.read_csv(r'C:\Users\Admin\.vscode\Airbnb_data.csv')
    return df
...
if select == "Home":
    ...
    image1= Image.open(r"C:\Users\Admin\Downloads\Airbnb_logo.png")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv(r'C:\Users\Admin\.vscode\Airbnb_data.csv')
            return df_a
